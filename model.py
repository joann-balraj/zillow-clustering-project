...
def select_kbest(x, y, k):
    ...
    f_selector.fit(wrangle.X_train_scaled, wrangle.y_train)
    
    # boolean mask of whether the column was selected or not. 
    feature_mask = f_selector.get_support()
    
    f_feature = wrangle.X_train_scaled.iloc[:,feature_mask].columns.tolist()
...
def rfe(x, y, k):
    ...
    X_rfe = rfe.fit_transform(wrangle.X_train_scaled,wrangle.y_train)  
    
    mask = rfe.support_
    
    rfe_features = wrangle.X_train_scaled.loc[:,mask].columns.tolist()
